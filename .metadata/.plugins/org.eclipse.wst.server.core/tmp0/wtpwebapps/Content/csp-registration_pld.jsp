              ...
              <p class="text-muted">CSP Registration</p> -->
				...
				<form class="user">
					  ...
					  <div class="form-group">
              			...
              			<input class="form-control form-control-user" type="text" id="CompanyName">
					  </div>
          
					  <div class="form-row">
						<div class="form-group col-lg-3">
						  <label for="content-type">Content type</label>
						  <select class="form-control-user selectpicker" id="contentType" name="contentType">
						...
						<div id="channel_id" class="form-group col-lg-3">
					  ...
					  <div class="form-row">
						<div class="form-group col-lg-12">
						  ...
						  <textarea class="form-control form-control-user" id="address" name="address"></textarea>
					  ...
					  <strong>CONTACT INFO</strong>
					   ...
					   <div class="form-group">
              			...
              			<input class="form-control form-control-user" type="text" id="contactPerson" name="contactPerson">
					  </div>
						...
						<div class="form-row">
							<div class="form-group col-6">
								...
								<input class="form-control form-control-user" autocomplete="off" type="password"  id="password" name="password" onkeyup="passwordCheck(this.value, 'password')"> 
							</div>

							<div class="form-group col-6">
								<label for="password">Re-type password</label>
								<input class="form-control form-control-user" type="password" id="cPassword" name="cPassword">
							</div>
						</div>
						  <div class="form-row">
