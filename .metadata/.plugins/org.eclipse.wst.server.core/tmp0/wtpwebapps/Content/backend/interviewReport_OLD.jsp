	    	   ...
	    	   keyword: keyword
		          ...
		          success: function(list){  
			          ...
			          $.each(list.data, function(index,list) {        
							...
							s += '<td> <a class="btn btn-primary btn-circle btn-sm" href="#viewInterviewLibrary" data-toggle="modal" title="VIEW"  onclick="getContent('+list.analysisID+','+list.channelID+',\''+list.contentDate.trim()+'\',\''+list.startTime.trim()+'\',\''+list.endTime.trim()+'\');" ><i class="fas fa-eye"></i></a>&nbsp; </td>';
							s += '</tr>';
			          });	
