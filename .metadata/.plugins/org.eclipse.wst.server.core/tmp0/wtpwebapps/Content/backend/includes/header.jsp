...
<meta
	http-equiv="Content-Security-Policy: default-src 'self'; script-src 'self'">
...
<link rel="icon" href="img/tcra-logo.png" width="100%" height="100%"
	class="img-fluid">
...
<body class="app header-fixed sidebar-fixed aside-menu-fixed sidebar-lg-show">
	<header class="app-header navbar">
		...
		<a class="navbar-brand" href="#"> <img class="navbar-brand-full"
			src="img/brand/tcra_bright.png" width="65" height="55"
			alt="TCMS Logo"> <img class="navbar-brand-minimized"
			src="img/brand/sygnet.svg" width="30" height="30" alt="TCMS Logo">
		</a>
