	    	   ...
	    	   contentTypeID: contentTypeID
		          ...
		          success: function(channelList){  
			          ...
			          $.each(channelList.data, function(index,channelList) {        
			                s += '<li class="list-group-item"><a class="adddiv" data-id="'+ channelList.channelID +'" onClick="getChannelID('+ channelList.channelID +',\''+channelList.channelName.trim()+'\');" style="text-decoration:none;">'+channelList.channelName+'</a> </li>'; 
			          });
			          s += '</ul>';     
			          $('#result').html(s);
...
function getChannelID(val,chanName){	
			      ...
			      url: "actions/components/channelTVAction.jsp", //this is my servlet
			       data: {
			          ...
			          success: function(msg){  
			              ...
			              var channelName = chanName; //array[2];
			             ...
			             // alert(videoSRCUrl);
							...
							if($('div #media-player').length <= 0){
								...
								var html ='<div class="col-sm-10" style="border:1px solid black; width:1000px; border-radius: 20px 20px; display: block; padding:10px; margin:20px;">';
									...
									html+='<video id="classic-video" class="media-video" width="480" height="340" autoplay="" poster="">';
