				  ...
				  <div class="col-lg-6 mt-3">
					<div class="p-5">
					  <div class="text-center">
						<h1 class="h4 text-gray-900 mb-4">Welcome to CSP: Online Users</h1>
						<h5 class="card-title text-muted">Success Registered User</h5>
					  </div>
					  ...
					  <form class="user" action="" method="">
						...
						<button type="submit" class="btn btn-success btn-lg btn-block">Your Account has been Successfully Activated</button>
						<br><br>
						<button type="submit" class="btn btn-primary btn-lg btn-block" style="color:white;"><a href="index.jsp" style="color:white;">Back to Login</a></button>
