...
function getDay(){
	...
	$.ajax({ 
	     type: "post",
	      url: "get-applied-programs.jsp", //this is my servlet
	       data: {
			  day: day
	           }, 
...
<ul class="navbar-nav ml-auto">
  ...
  <li class="nav-item dropdown no-arrow">
    <a class="nav-link dropdown-toggle" href="#" id="userDropdown" role="button" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
      <span class="mr-2 d-none d-lg-inline text-gray-600 small"><% out.print(session.getAttribute("channel_name")); %> | <% out.print(session.getAttribute("contact_person")); %></span>
