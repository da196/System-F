 ...
 * Generated at: 2020-04-29 12:58:57 UTC
...
if (session.getAttribute("userID") != null && session.getAttribute("roleID").equals("3") ) {
      ...
      out.write("\t\t\t                s += '<li class=\"list-group-item\"><a class=\"adddiv\" data-id=\"'+ channelList.channelID +'\" onClick=\"getChannelID('+ channelList.channelID +',\\''+channelList.channelName.trim()+'\\');\" style=\"text-decoration:none;\">'+channelList.channelName+'</a> </li>'; \r\n");
      out.write("\t\t\t          });\r\n");
      out.write("\t\t\t          s += '</ul>';     \r\n");
 ...
 out.print(day); 
      ...
      out.write("          </li>\r\n");
      out.write("          <li class=\"breadcrumb-item\">\r\n");
      out.write("          <a href=\"channel-tv.jsp\">TV</a>\r\n");
      out.write("          </li>\r\n");
      out.write("         \r\n");
      out.write("        </ol>\r\n");
 ...
 out.print(contentList.get(i).getRegionName()); 
      ...
      out.write("function getChannelID(val,chanName){\t\r\n");
      out.write("\t\t\t\r\n");
      ...
      out.write("\t\t\tvar content_type_id = \"1\";\r\n");
      out.write("\t\t\tvar today = new Date();\r\n");
      out.write("\t\t\t//var time = today.getHours() + \":\" + (today.getMinutes() - 1) + \":\" + today.getSeconds();\r\n");
      ...
      out.write("\t\t\t              var channelName = chanName; //array[2];\r\n");
      out.write("\t\t\t              var videoSRCUrl = array[3];\r\n");
      out.write("\t\t\t             // alert(videoSRCUrl);\r\n");
      ...
      out.write("\t\t\t\t\t\t\t\t\thtml+='<video id=\"classic-video\" class=\"media-video\" width=\"480\" height=\"340\" autoplay=\"\" poster=\"\">';\r\n");
      out.write("\t\t\t\t\t\t\t\t\thtml+='<source src=\"'+videoUrl+'\" id=\"mp4Source\" type=\"video/mp4\" />';\r\n");
      out.write("\t\t\t\t\t\t\t\t\thtml+='Your browser does not support the video element.';\r\n");
      out.write("\t\t\t\t\t\t\t\t\thtml+='</video>';\r\n");
      out.write("\t\t\t\t\t\t\t\t\thtml+='</div>';\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\r\n");
      out.write("\t\t\t\t\t\t\t\t\thtml+='</div>';\r\n");
      ...
      out.write("\t\t\t\t\t\t\t\t   }\r\n");
      out.write("\t\t\t\t\t\t\t\t   count++;\r\n");
      out.write("\t\t\t\t\t\t\t\t   $(mp4Vid).attr('src', URL +count+\".mp4\");\r\n");
